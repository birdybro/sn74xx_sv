...
module tb_ttl_74x7822;
    ...
    initial begin
        ...
        if (ef_n_ab !== 0) errors++;
        din_ab = 32'd17; wr_n_ab = 0;
        #1; wclk_ab = 1; #1; wclk_ab = 0; wr_n_ab = 1; #1;
        if (dout_ab !== 32'd17) errors++;
        if (errors != 0) $fatal(1, "tb_ttl_74x7822: %0d errors", errors);
        $display("PASS: tb_ttl_74x7822");
        $finish;
    end
endmodule
