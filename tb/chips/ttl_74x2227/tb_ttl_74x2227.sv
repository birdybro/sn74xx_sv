...
module tb_ttl_74x2227;
    ...
    initial begin
        ...
        if (ef_n_ab !== 0) errors++;
        din_ab = 1'(17); wr_n_ab = 0;
        #1; wclk_ab = 1; #1; wclk_ab = 0; wr_n_ab = 1; #1;
        if (dout_ab !== 1'(17)) errors++;
        if (errors != 0) $fatal(1, "tb_ttl_74x2227: %0d errors", errors);
        $display("PASS: tb_ttl_74x2227");
        $finish;
    end
endmodule
