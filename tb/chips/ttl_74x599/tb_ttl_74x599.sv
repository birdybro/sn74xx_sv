...
module tb_ttl_74x599;
    ...
    initial begin
        ...
        sin=1; ts; sin=1; ts; sin=1; ts; sin=0; ts;
        sin=0; ts; sin=0; ts; sin=1; ts; sin=1; ts;
        tl;
        if (q !== 8'b11100011) errors++;
        if (errors != 0) $fatal(1, "tb_ttl_74x599: %0d errors", errors);
        $display("PASS: tb_ttl_74x599");
        $finish;
    end
endmodule
