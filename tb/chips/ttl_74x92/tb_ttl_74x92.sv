...
module tb_ttl_74x92;
    ...
    ttl_74x92 dut(.clk_a(clk_a), .clk_b(clk_b), .r0_1(r0_1), .r0_2(r0_2),
    ...
    initial begin
        ...
        for (int i = 0; i < 7; i++) begin
            if ({q_d, q_c, q_b} !== 3'(i % 6)) errors++;
            tickB;
        end
        if (errors != 0) $fatal(1, "tb_ttl_74x92: %0d errors", errors);
        $display("PASS: tb_ttl_74x92");
        $finish;
    end
endmodule
