...
module tb_ttl_74x29854;
    ...
    initial begin
        errors = 0;
        clk = 0; oea_n = 1; oeb_n = 0; a_in = 8'h0F; b_in = 0; parity_in = 0;
        clr_n = 1; #1; clr_n = 0; #1; clr_n = 1; #1;
        if (b_out !== 8'h0F) errors++;
        if (errors != 0) $fatal(1, "tb_ttl_74x29854: %0d errors", errors);
        $display("PASS: tb_ttl_74x29854");
        $finish;
    end
endmodule
