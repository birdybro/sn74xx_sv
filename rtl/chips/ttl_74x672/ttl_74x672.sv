// =============================================================================
// ttl_74x672 - 4-bit universal shift register/latch with 3-state outputs
//
// Original part number : 74x672 (SN74LS672)
...
//
//   Shift register (posedge srck), synchronous clear via srclr_n; mode = {s1,s0}:
...
module ttl_74x672 (
    ...
    input  logic       srclr_n,  // shift-register clear, active low (synchronous clear)
