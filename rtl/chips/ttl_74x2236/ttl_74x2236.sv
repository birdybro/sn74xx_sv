// ttl_74x2236 - 18432-bit bidirectional FIFO memory (2x1024x9).
// Logically identical to ttl_74x2235; differs only in package option /
// pinout details that are not modeled behaviorally.
module ttl_74x2236 (
    input  logic       rst_n,
