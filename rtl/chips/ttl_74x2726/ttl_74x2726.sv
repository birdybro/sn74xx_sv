// ttl_74x2726 - 4608-bit bidirectional FIFO memory (2x256x9).
// Same dual-queue structure as ttl_74x2235, with each direction sized to
// 256 deep x 9 bits (total 256*9*2 = 4608 bits).
module ttl_74x2726 (
    input  logic       rst_n,
